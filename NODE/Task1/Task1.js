...
function showmen()
{
    ...
    var kids=[];
        ...
        fs.writeFileSync('Mens.json', JSON.stringify(mens));
        fs.writeFileSync('WoMens.json',JSON.stringify(womens));
        fs.writeFileSync('Kids.json',JSON.stringify(kids));

}
showmen();
function readdetails(genders)
{
    if(genders=='MEN')
    {
        fs.readFile('mens.json','utf-8',(err,data)=>
        {
            console.log(data);
    ...
    {
        fs.readFile('WoMens.json','utf-8',(err,data)=>
        {
            console.log(data);
    ...
    {
        fs.readFile('Kids.json','utf-8',(err,data)=>
        {
